---
title: "Estimation, échantillonnage et expériences"
date: "<br/>7 septembre 2023"
output:
  pdf_document:
    toc: yes
  html_document:
...
En bref, un bon plan d'expérience vise à isoler l'effet de la variable étudiée tout en contrôlant les autres sources de variation. Voici quelques principes utiles en lien avec cet objectif.
...
Dans l'élaboration d'un plan d'expérience, il est important d'assigner de façon aléatoire les traitements entre les unités expérimentales (ex.: individus ou sites). Il peut être avantageux de grouper les unités expérimentales plus semblables en blocs afin que tous les traitements soit représentés dans chaque bloc (avec assignation aléatoire à l'intérieur des blocs).
